 ...
 * 
 */
var DE405PlusAscp2000;
var DE405PlusAscp2020;
function DE405PlusForTime(time) {
	var jultime = time.jd_tt();
	var ephemeris = null;
	if ((jultime >= 2451536.5) && (jultime < 2458832.5)) {
		ephemeris = DE405PlusAscp2000;
	} else if ((jultime >= 2458832.5) && (jultime < 2466128.5)) {
		ephemeris = DE405PlusAscp2020;
	} else {
		console.log("Unsupported Julian Day")
	}
	return ephemeris;
}
function loadDE405Plus(callback) {
	if (DE405PlusAscp2000 == null) {
        var pathUtil = new PathUtil();
		DE405PlusAscp2000 = new DE405Plus(pathUtil);
		DE405PlusAscp2000.update_planetary_ephemeris(new Time({Yr:2010, Mon:1, D:1, Hr:1, Mn:1, S:1}), function() {
			if (DE405PlusAscp2020 == null) {
		        var pathUtil = new PathUtil();
				DE405PlusAscp2020 = new DE405Plus(pathUtil);
				DE405PlusAscp2020.update_planetary_ephemeris(new Time({Yr:2020, Mon:1, D:1, Hr:1, Mn:1, S:1}), function() {
					callback();
				});
			}
		});
...
//	}
	...
	/*public*/function DE405Plus(/*PathUtil*/ path) {
		this.initialize();
		this.path = path;
...
//	}
	...
	/*public int */DE405Plus.prototype.getDimension = function() {
		return 6;
	};
...
//	}
	...
	/*public void  */DE405Plus.prototype.update_posvel_and_frame = function(/*Time*/ t, callback) /*throws IOException*/ {
...
//	}
	...
	/*public VectorN */DE405Plus.prototype.get_planet_pos = function(/*body*/ bodyEnum, /*Time*/ t, callback) /*throws IOException*/ {
	...
	/*public VectorN */DE405Plus.prototype.get_planet_vel = function(/*body*/ bodyEnum, /*Time*/ t, callback) /*throws IOException*/ {
