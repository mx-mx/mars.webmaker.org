...
//	public int length;
	...
	function VectorN(inputOptions) {
		...
		if (inputOptions.n != null) {
			this.VectorN_n(inputOptions.n);
		} else if (inputOptions.B != null) {
			this.VectorN_B(inputOptions.B);
		} else if ((inputOptions.x != null) && (inputOptions.y != null) && (inputOptions.z != null)) {
			this.VectorN_xyz(inputOptions.x, inputOptions.y, inputOptions.z);
		} else if ((inputOptions.y != null) && (inputOptions.z != null)) {
			this.VectorN_yz(inputOptions.y, inputOptions.z);
		} else if (inputOptions.y != null) {
			this.VectorN_y(inputOptions.y);
		} else {
			console.log("No constructor for VectorN:" + inputOptions);
		}
	}
	...
	VectorN.prototype.VectorN_n = function(/*int*/ n) {
		this.length = n;
		this.x = new Array(n);//double[n];
...
//	}
	...
	VectorN.prototype.VectorN_B = function(/*double[]*/ B) {
		this.length = B.length;
		this.x = new Array(this.length);//double[this.length];
...
//	}	
	...
	VectorN.prototype.VectorN_y = function(/*VectorN*/ y) {
	 ...
	 * @param z    VectorN.
	 */
	VectorN.prototype.VectorN_yz = function(/*VectorN*/ y, /*VectorN*/ z) {
		this.length = y.length + z.length;
		this.x = new Array(this.length);//double[this.length];
		for (var /*int*/ i = 0; i < y.length; i++) {
			this.x[i] = y.x[i];
		}
		for (var /*int*/ i = 0; i < z.length; i++) {
			var /*int*/ j = i + y.length;
			this.x[j] = z.x[i];
		}
	...
	VectorN.prototype.VectorN_xyz = function(/*double*/ x, /*double*/ y, /*double*/ z) {
		this.length = 3;
		this.x = new Array(3);//double[3];
		this.x[0] = x;
		this.x[1] = y;
		this.x[2] = z;
	};
...
//	}
	...
	/*public double */VectorN.prototype.get = function(/*int*/ i) {
		return this.x[i];
	};
...
//	}
	...
	/*public double */VectorN.prototype.mag = function() {
		var /*double*/ out = 0.0;
		for (var /*int*/ i = 0; i < this.length; i++) {
...
//	}
	...
	/*public VectorN */VectorN.prototype.plus = function(/*VectorN*/ B) {
		this.checkVectorDimensions_B(B);
		var /*VectorN*/ out = new VectorN({n:this.length});
	...
	/*public VectorN */VectorN.prototype.minus = function(/*VectorN*/ B) {
		this.checkVectorDimensions_B(B);
		var /*VectorN*/ out = new VectorN({n:this.length});
	...
	/*public VectorN */VectorN.prototype.times = function(/*double*/ s) {
		var /*VectorN*/ out = new VectorN({n:this.length});
...
//	}
	...
	/*public double */VectorN.prototype.dotProduct = function(/*VectorN*/ B)
...
//	}
	...
	/*public VectorN */VectorN.prototype.crossProduct = function(/*VectorN*/ B) {
		this.checkVectorDimensions_n(3);
		this.checkVectorDimensions_B(B);
		var /*VectorN*/ out = new VectorN({n:3});
...
//	}
	...
	/*public void */VectorN.prototype.checkVectorDimensions_B = function(/*VectorN*/ B) {
		if (B == null) {
			console.log("VectorN.prototype.checkVectorDimensions_B, B is null!");
		}
	...
	/*public void */VectorN.prototype.checkVectorDimensions_n = function(/*int*/ n) {
		if (this.length != n) {
			throw new IllegalArgumentException(
